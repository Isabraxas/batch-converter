package cc.viridian.servicebatchconverter.persistence.auto;
...
public abstract class _StatementHeader extends CayenneDataObject {
    ...
    public static final Property<String> FILE_HASH = Property.create("fileHash", String.class);
    ...
    public static final Property<List<StatementDetail>> HEADER_DETAIL = Property.create("headerDetail", List.class);
    ...
    public void setFileHash(String fileHash) {
        writeProperty("fileHash", fileHash);
    }
    public String getFileHash() {
        return (String)readProperty("fileHash");
    }
    ...
    public void addToHeaderDetail(StatementDetail obj) {
        addToManyTarget("headerDetail", obj, true);
    }
    public void removeFromHeaderDetail(StatementDetail obj) {
        removeToManyTarget("headerDetail", obj, true);
    }
    @SuppressWarnings("unchecked")
    public List<StatementDetail> getHeaderDetail() {
        return (List<StatementDetail>)readProperty("headerDetail");
    }
