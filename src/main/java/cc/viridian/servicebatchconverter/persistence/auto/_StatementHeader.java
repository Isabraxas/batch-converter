...
public abstract class _StatementHeader extends CayenneDataObject {
    ...
    public static final Property<List<StatementDetail>> STATEMENT_DETAIL = Property.create("statementDetail", List.class);
    ...
    public void addToStatementDetail(StatementDetail obj) {
        addToManyTarget("statementDetail", obj, true);
    }
    public void removeFromStatementDetail(StatementDetail obj) {
        removeToManyTarget("statementDetail", obj, true);
    }
    @SuppressWarnings("unchecked")
    public List<StatementDetail> getStatementDetail() {
        return (List<StatementDetail>)readProperty("statementDetail");
    }
